...
def get_manual_sigs():
    manual_sigs = {
        ...
        "int": [
            param("x", param.POSITIONAL_OR_KEYWORD),
        ...
        "issubclass": [
            param("cls", param.POSITIONAL_ONLY),
            param("class_or_tuple", param.POSITIONAL_ONLY),
        ],
        ...
        "open": [
            param("file", param.POSITIONAL_OR_KEYWORD),
        ...
        "round": [
            param("number", param.POSITIONAL_OR_KEYWORD),
        ...
        # str
        "str.center": [
            param("width", param.POSITIONAL_ONLY),
        ...
        # numpy
        "numpy.array": [
            param("object", param.POSITIONAL_OR_KEYWORD),
        ...
        "numpy.random.randint": [
            param("low", param.POSITIONAL_OR_KEYWORD),
        ...
        "numpy.random.choice": [
            param("a", param.POSITIONAL_OR_KEYWORD),
            param("size", param.POSITIONAL_OR_KEYWORD, default=None),
            param("replace", param.POSITIONAL_OR_KEYWORD, default=True),
            param("p", param.POSITIONAL_OR_KEYWORD, default=None),
        ],
        "numpy.random.normal": [
            param("loc", param.POSITIONAL_OR_KEYWORD, default=0.0),
            param("scale", param.POSITIONAL_OR_KEYWORD, default=1.0),
            param("size", param.POSITIONAL_OR_KEYWORD, default=None),
        ],
        "numpy.random.poisson": [
            param("lam", param.POSITIONAL_OR_KEYWORD, default=1.0),
            param("size", param.POSITIONAL_OR_KEYWORD, default=None),
        ],
        "numpy.random.binomial": [
            param("n", param.POSITIONAL_OR_KEYWORD),
