...
@pytest.mark.parametrize('sct, passes', [
    ...
    ("test_or(lambda: test_student_typed('a'), lambda: test_student_typed('b'))", True),
    ...
    ("test_or(lambda: test_student_typed('b'), lambda: test_student_typed('c'))", False),
...
@pytest.mark.parametrize('sct, passes, msg', [
    ...
    ("Ex().test_correct(test_student_typed('a'), test_student_typed('b'))", True, None),

    ("test_correct(lambda: test_student_typed('a'), lambda: test_student_typed('c'))", True, None),
    ("test_correct(test_student_typed('a'), test_student_typed('c'))", True, None),
    ("Ex().test_correct(has_code('a'), has_code('c'))", True, None),
    ("Ex().test_correct(test_student_typed('a'), test_student_typed('c'))", True, None),

    ("test_correct(lambda: test_student_typed('b'), lambda: test_student_typed('c', not_typed_msg='x'))", False, 'x'),
    ("test_correct(test_student_typed('b'), test_student_typed('c', not_typed_msg='x'))", False, 'x'),
    ("Ex().test_correct(has_code('b'), has_code('c', not_typed_msg='x'))", False, 'x'),
    ("Ex().test_correct(test_student_typed('b'), test_student_typed('c', not_typed_msg='x'))", False, 'x'),

    ("test_correct(lambda: test_student_typed('b', not_typed_msg='x'), lambda: test_student_typed('a'))", False, 'x'),
    ("test_correct(test_student_typed('b', not_typed_msg='x'), test_student_typed('a'))", False, 'x'),
    ("Ex().test_correct(has_code('b', not_typed_msg='x'), has_code('a'))", False, 'x'),
    ("Ex().test_correct(test_student_typed('b', not_typed_msg='x'), test_student_typed('a'))", False, 'x')
])
