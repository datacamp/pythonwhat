...
class TestArgsKeywords(unittest.TestCase):
    ...
    def test_argsissue_builtin1(self):
        self.data = {
            "DC_PEC": '',
            "DC_SOLUTION": "file = open('moby_dick.txt', 'r')\nfile.close()",
            "DC_CODE": "file = open('moby_dick.txt', 'r')\nfile.close()",
            "DC_SCT": 'test_function("open", incorrect_msg="incorrect")'
        }
        sct_payload = helper.run(self.data)
        self.assertTrue(sct_payload['correct'])


    def test_argsissue_builtin2(self):
        self.data = {
            "DC_PEC": '',
            "DC_SOLUTION": "file = open('moby_dick.txt', 'r')\nfile.close()",
    ...
    def test_argsissue__builtin3(self):
        self.data = {
            "DC_PEC": '',
    ...
    def test_argsissue_builtin4(self):
        self.data = {
            "DC_PEC": '',
            "DC_SOLUTION": "file = open('moby_dick.txt', mode='r')\nfile.close()",
            "DC_CODE": "file = open('moby_dick.txt', 'r')\nfile.close()",
            "DC_SCT": 'test_function("open")'
        }
        sct_payload = helper.run(self.data)
        self.assertTrue(sct_payload['correct'])


    def test_argsissue_class1(self):
        self.data = {
    ...
    def test_argsissue_class2(self):
        self.data = {
            "DC_PEC": "import pandas as pd; import numpy as np",
    ...
    def test_argsissue_class3(self):
        self.data = {
            "DC_PEC": "import pandas as pd; import numpy as np",
    ...
    def test_argsissue_fun1(self):
        self.data = {
            "DC_PEC": "import pandas as pd",
            "DC_SOLUTION": "pd.read_csv('cars.csv', index_col = 0)",
            "DC_CODE": "pd.read_csv('cars.csv', index_col = 0)",
            "DC_SCT": "test_function('pandas.read_csv')"
        }
        sct_payload = helper.run(self.data)
        self.assertTrue(sct_payload['correct'])

    def test_argsissue_fun2(self):
        self.data = {
            "DC_PEC": "import pandas as pd",
            "DC_SOLUTION": "pd.read_csv(filepath_or_buffer = 'cars.csv', index_col = 0)",
            "DC_CODE": "pd.read_csv('cars.csv', index_col = 0)",
            "DC_SCT": "test_function('pandas.read_csv')"
        }
        sct_payload = helper.run(self.data)
    ...
    def test_argsissue_fun3(self):
        self.data = {
            "DC_PEC": "import pandas as pd",
            "DC_SOLUTION": "pd.read_csv(index_col = 0, filepath_or_buffer = 'cars.csv')",
            "DC_CODE": "pd.read_csv(filepath_or_buffer, 'cars.csv', index_col = 0)",
            "DC_SCT": "test_function('pandas.read_csv')"
        }
        sct_payload = helper.run(self.data)
        self.assertTrue(sct_payload['correct'])
